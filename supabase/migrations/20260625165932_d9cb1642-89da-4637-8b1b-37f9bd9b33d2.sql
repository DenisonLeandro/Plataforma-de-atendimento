CREATE OR REPLACE FUNCTION public.get_conversation_counters(_instance_id uuid DEFAULT NULL::uuid, _status text DEFAULT NULL::text, _status_in text[] DEFAULT NULL::text[], _assigned_to uuid DEFAULT NULL::uuid, _unassigned boolean DEFAULT false)
